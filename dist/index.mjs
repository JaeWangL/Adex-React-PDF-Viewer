...
var require_jp_JP = __commonJS({
  "src/locales/jp_JP.json"(exports, module) {
    module.exports = {
      navigation: {
        previousPage: "\u524D\u306E\u30DA\u30FC\u30B8",
        nextPage: "\u6B21\u306E\u30DA\u30FC\u30B8",
...
var require_mr = __commonJS({
  "src/locales/mr.json"(exports, module) {
    module.exports = {
      navigation: {
...
var require_zh_TW = __commonJS({
  "src/locales/zh_TW.json"(exports, module) {
    module.exports = {
      navigation: {
        previousPage: "\u4E0A\u4E00\u9801",
        nextPage: "\u4E0B\u4E00\u9801",
      ...
      children: [
        showToolbar && /* @__PURE__ */ jsxs("div", { className: "adex-topbar", children: [
          (showControls == null ? void 0 : showControls.navigation) && /* @__PURE__ */ jsxs("div", { className: "adex-control-page", children: [
            (showControls == null ? void 0 : showControls.sidebarButton) ? /* @__PURE__ */ jsx("button", { onClick: () => setSidebar(!sidebar), "aria-label": "Toggle sidebar", title: "Toggle sidebar", children: /* @__PURE__ */ jsxs(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
            ...
            /* @__PURE__ */ jsx("button", { disabled: pageNumber <= 1, onClick: () => goToPage(pageNumber - 1), "aria-label": getLocaleData("navigation.previousPage", "Previous page"), title: getLocaleData("navigation.previousPage", "Previous page"), children: /* @__PURE__ */ jsx(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
          ...
          (showControls == null ? void 0 : showControls.zoom) && /* @__PURE__ */ jsxs("div", { className: "adex-control-zoom", children: [
            ...
            /* @__PURE__ */ jsx("select", { onChange: (e) => setScale(+e.target.value), value: scale, "aria-label": getLocaleData("toolbar.zoomLevel", "Zoom level"), title: getLocaleData("toolbar.zoomLevel", "Zoom level"), children: scaleSets.map((scaleLevel) => /* @__PURE__ */ jsxs("option", { value: scaleLevel, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "adex-control-options", children: [
            (showControls == null ? void 0 : showControls.print) && /* @__PURE__ */ jsx("button", { onClick: handlePrint, "aria-label": getLocaleData("toolbar.print", "Print document"), title: getLocaleData("toolbar.print", "Print document"), children: /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16", children: [
            ...
            (showControls == null ? void 0 : showControls.fullscreen) && /* @__PURE__ */ jsx("button", { onClick: toggleFullscreen, "aria-label": fullScreenView ? getLocaleData("toolbar.exitFullscreen", "Exit fullscreen") : getLocaleData("toolbar.fullscreen", "Enter fullscreen"), title: fullScreenView ? getLocaleData("toolbar.exitFullscreen", "Exit fullscreen") : getLocaleData("toolbar.fullscreen", "Enter fullscreen"), children: !fullScreenView ? /* @__PURE__ */ jsx(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
        ...
        /* @__PURE__ */ jsxs("div", { className: "adex-preview-panel", style: { display: "flex" }, children: [
          /* @__PURE__ */ jsxs("div", { className: "adex-left-col", style: { flexShrink: 0 }, children: [
            ...
            (showControls == null ? void 0 : showControls.localization) && /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => {
                ...
                children: /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16", children: [
                  /* @__PURE__ */ jsx("path", { d: "M4.545 6.714 4.11 8H3l1.862-5h1.284L8 8H6.833l-.435-1.286zm1.634-.736L5.5 3.956h-.049l-.679 2.022z" }),
              ...
              children: [
                ...
                leftPanel == 1 && /* @__PURE__ */ jsxs("div", { className: "adex-preview-search", ref: searchResultsRef, children: [
                  /* @__PURE__ */ jsxs("div", { className: "adex-search-bar", children: [
                    /* @__PURE__ */ jsxs("div", { className: "adex-search-results-header", children: [
                      /* @__PURE__ */ jsxs("div", { children: [
                        /* @__PURE__ */ jsx("h3", { children: getLocaleData("search.title", "Search") }),
                  ...
                  /* @__PURE__ */ jsx("div", { className: "adex-search-results-list", children: searchResults.length > 0 ? searchResults.map((result, index) => /* @__PURE__ */ jsxs(
                    ...
                    `search-result-${index}`
                  )) : /* @__PURE__ */ jsx("div", { className: "adex-search-no-results", children: isSearching ? getLocaleData("search.searching", "Searching...") : getLocaleData("search.noResults", "No results found") }) })
                ] }),
                    ...
                    /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        children: [
                          ...
                          " ",
                          /* @__PURE__ */ jsx("span", { children: getLocaleData("bookmarks.outline", "Outline") })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx("span", { children: getLocaleData("bookmarks.bookmarks", "Bookmarks") })
                        ]
                      }
                    )
                  ] }) }),
                  /* @__PURE__ */ jsx("div", { className: "adex-bookmarks-content", children: activeTab === "outline" ? /* @__PURE__ */ jsx("div", { className: "adex-outline-container", children: documentOutline.length > 0 ? /* @__PURE__ */ jsx("div", { className: "adex-outline-list", children: renderOutlineItems(documentOutline) }) : /* @__PURE__ */ jsx("div", { className: "adex-no-outline", children: getLocaleData("bookmarks.noBookmarks", "No bookmarks added yet") }) }) : /* @__PURE__ */ jsxs("div", { className: "adex-bookmarks-container", children: [
                    ...
                    ] }, bookmark.id)) : /* @__PURE__ */ jsx("div", { className: "adex-no-bookmarks", children: getLocaleData("bookmarks.noBookmarks", "No bookmarks added yet") }) })
                  ] }) })
                ] }),
                leftPanel == 3 && /* @__PURE__ */ jsxs("div", { className: "adex-preview-annotations", children: [
                  /* @__PURE__ */ jsxs("div", { className: "adex-annotations-header", children: [
                    /* @__PURE__ */ jsx("h3", { children: getLocaleData("annotations.title", "Annotations") }),
                    ...
                    isAddingAnnotation && /* @__PURE__ */ jsxs("div", { className: "adex-annotation-color-picker", children: [
                      ...
                      /* @__PURE__ */ jsx("button", { className: "adex-cancel-annotation", onClick: cancelAddingAnnotation, "aria-label": getLocaleData("annotations.cancel", "Cancel"), children: getLocaleData("annotations.cancel", "Cancel") })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "adex-annotations-list", children: annotations.length > 0 ? annotations.sort((a, b) => b.createdAt - a.createdAt).map((annotation) => /* @__PURE__ */ jsxs(
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", { className: "adex-annotation-list-item", children: [
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "adex-annotation-content", children: [
                            ...
                            /* @__PURE__ */ jsx("div", { className: "adex-annotation-preview", children: annotation.content ? annotation.content.substring(0, 50) + (annotation.content.length > 50 ? "..." : "") : getLocaleData("annotations.noContent", "No content") })
                          ] })
                        ] }),
                    ...
                    annotation.id
                  )) : /* @__PURE__ */ jsx("div", { className: "adex-no-annotations", children: getLocaleData("annotations.noAnnotations", "No annotations added yet. Use the tools above to add annotations to your document.") }) })
                ] })
              ]
            }
          ),
          ...
          showLocaleOption && /* @__PURE__ */ jsx("div", { className: "adex-pdf-meta-info adex-locales-panel", children: /* @__PURE__ */ jsxs("div", { className: "adex-meta-panel", children: [
            /* @__PURE__ */ jsxs("div", { className: "adex-pdf-meta-info-header", children: [
              /* @__PURE__ */ jsxs("strong", { children: [
                " ",
                /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "adex-pdf-meta-info-content", children: /* @__PURE__ */ jsx("ul", { className: "adex-language-list", "aria-label": getLocaleData("locale.selectLanguage", "Select Language"), children: localization == null ? void 0 : localization.map((language) => /* @__PURE__ */ jsx("li", { className: `adex-language-option ${language.locale == locale ? "active-lang" : ""}`, onClick: (e) => handleChangeLocale(language.locale), "aria-label": `${getLocaleData("locale.changeTo", "Change language to")} ${language == null ? void 0 : language.title}`, title: `${getLocaleData("locale.changeTo", "Change language to")} ${language == null ? void 0 : language.title}`, children: language.title }, language == null ? void 0 : language.title)) }) })
          ] }) })
        ] }),
